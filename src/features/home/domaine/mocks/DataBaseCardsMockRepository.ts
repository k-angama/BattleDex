...
const aquaGuardian: CardEntity = {
  ...
  attacks: [
    { name: 'Tidal Wave', damage: 90, energyCost: 3 },
    { name: 'Bubble Armor', damage: 60, energyCost: 2 },
  ],
  weaknesses: [{ type: 'Electric', value: '×2' }],
...
const pyroblazeDragon: CardEntity = {
  ...
  attacks: [
    { name: 'Inferno Burst', damage: 110, energyCost: 4 },
    { name: 'Scorching Tail', damage: 80, energyCost: 3 },
  ],
...
const stormcallerFalcon: CardEntity = {
  ...
  attacks: [
    { name: 'Thunder Dive', damage: 95, energyCost: 3 },
    { name: 'Sky Shock', damage: 70, energyCost: 2 },
  ],
  weaknesses: [{ type: 'Rock', value: '×2' }],
...
const obsidianGolem: CardEntity = {
  ...
  attacks: [
    { name: 'Quake Fist', damage: 100, energyCost: 4 },
    { name: 'Stone Wall', damage: 60, energyCost: 3 },
  ],
  weaknesses: [{ type: 'Water', value: '×2' }],
